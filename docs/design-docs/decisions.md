...
|---|---|---|---|
| 2026-05-15 | Add a public project note to the report footer | Growing public readership needs project context, source transparency, and a low-friction path for feedback | — |
